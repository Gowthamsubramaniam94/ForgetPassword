...
import 'package:flutter_forgetpassword/forgetpassword/newpassword.dart';
...
//            color: Colors.grey.withOpacity(0.4),
  ...
  void autoReadOTP() {
    ...
    print("Random OTP " + otp.toString());

    for (int i = 0; i < otp.toString().length; i++) {
      var char = otp.toString()[i];
      var aInt = int.parse(char);
      switch (i) {
        case 0:
          _firstDigit = aInt;
          break;
